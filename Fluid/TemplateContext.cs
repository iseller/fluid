...
namespace Fluid
{
    public class TemplateContext
    {
        ...
        /// </summary>
        public Dictionary<string, object> AmbientValues { get; set; } = new Dictionary<string, object>();
        ...
        public TemplateContext EnterChildContext()
        {
            return new TemplateContext(this.Model, this.Options)
            {
                LocalScope = new Scope(this.LocalScope),
                AmbientValues = new Dictionary<string, object>(this.AmbientValues)
            };
        }
    }
